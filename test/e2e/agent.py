...
def run_agent(pod_name, namespace):
    ...
    user_prompts = [f"""Review the OpenShift logs for the pod '{pod_name}' and container 'step-s2i-build', in the '{namespace}' namespace.
                ...
                Create a github issue using these parameters {{"name":"create_issue","arguments":{{"owner":"marcusviniciusaso","repo":"etx-agentic-ai","title":"Issue with Etx pipeline","body":"summary of the error."}}}}. DO NOT add any optional parameters."""]
