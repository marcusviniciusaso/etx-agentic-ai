...
def run_agent(pod_name, namespace):
    ...
    #     '{"owner":"marcusviniciusaso","repo":"etx-agentic-ai",'
    ...
    try:
        ...
        fallback_prompt = (
            ...
            "Then create a Github issue with owner 'marcusviniciusaso', repo 'etx-agentic-ai', "
